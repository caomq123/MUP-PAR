...
class Config(object):
    ...
    def __init__(self, dataset_name):
        ...
        # Gpu
        self.use_gpu = True
        self.use_multi_gpu = False          # True
        self.device_list = "0,1"
        ...
        # Activity Action
        self.num_actions = 27                  # number of action categories
        self.num_activities = 7                # number of activity categories
        self.num_social_activities = 32
        ...
        self.stage1_model_path = '/opt/data/private/O/PAR-main/PanoAct_source-code/result/epoch6_66.04%.pth'
